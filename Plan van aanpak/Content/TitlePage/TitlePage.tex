...
\begin{itemize}
	...
	\begin{itemize}
        \item[]{\makebox[5cm][l]{Naam} Naam van Bedrijfsbegeleider} 
		\item[]{\makebox[5cm][l]{Email} Email van Bedrijfsbegeleider}
		\item[]{\makebox[5cm][l]{Telefoonnummer} Nummer van Bedrijfsbegeleider}
		\item[]{\makebox[5cm][l]{Rol} Rol van Bedrijfsbegeleider}
	\end{itemize}
